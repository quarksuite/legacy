...
var tints = function tints(color) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
var tones = function tones(color) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
var shades = function shades(color) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
var complement = function complement(color) {
...
var neutralize = function neutralize(color) {
...
var split = function split(color) {
...
var spread = function spread(color) {
  var degrees = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 60;
...
var tetrad = function tetrad(color) {
  var degrees = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 60;
  var a = color;
...
var tokenize = function tokenize(data, key) {
...
var ColorsKit = /*#__PURE__*/Object.freeze({
  blend: blend,
  tints: tints,
  tones: tones,
  shades: shades,
