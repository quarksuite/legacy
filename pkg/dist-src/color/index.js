import { spin, blend, convert } from "./helpers.js";
/**
...
export const complement = color => spin(color);
/**
...
export const neutralize = color => blend(color, complement(color));
/**
...
export const mix = (color, target, amount = 50) => blend(color, target, amount);
/**
...
export const format = (color, format = 'rgb') => convert(color, format);
...
export const scheme = (color, type, options = {}) => {
 ...
 **/
export const variants = (color, target, options = {}) => {
  // Initialize the options
  const {
    contrast = 97,
    limit = 2,
