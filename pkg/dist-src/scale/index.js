import { ratios } from "./ratio-lookup.js";
/**
...
export const create = (base = 1, ratio = 'golden', limit = 6, invert = false) => {
...
export const modify = (scale, n, modifier) => scale.map(value => parseFloat(modifier(n, value).toPrecision(6)));
/**
 ...
 **/
export const output = (scale, unit = 'rem', precision = 4) => {
