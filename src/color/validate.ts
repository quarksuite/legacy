...
export const queryFormat = (color: CSSColor): ColorFormats => {
  ...
  const formats: Categories = {
    hex: /^#([\da-f]{3,4}){1,2}$/i,
    rgb: /^(?:rgba?\((?:(?:100%|(?:\d\.?\d?){1,}%)|(?:25[0-5]|2[0-4][0-9]|1[0-9]{2}|\d{1,2}|0))(?:[\s,]+)(?:(?:100%|(?:\d\.?\d?){1,}%)|(?:25[0-5]|2[0-4][0-9]|1[0-9]{2}|\d{1,}|0))(?:[\s,]+)(?:(?:100%|(?:\d\.?\d?){1,}%)|(?:25[0-5]|2[0-4][0-9]|1[0-9]{2}|\d{1,}|0))(?:(?:[,\s/]+)(?:(?:0|0\.\d+|1)|(?:100%|(?:\d\.?\d?){1,}%)))?\))$/,
    hsl: /^(?:hsla?\((?:-?(?:(?:\d\.?\d?)(?:deg|g?rad|turn)?)+(?:[\s,]+))(?:(?:100|(?:\d\.?\d?){1,})%)(?:[\s,]+)(?:(?:100|(?:\d\.?\d?){1,})%)(?:(?:[\s,/]+)(?:(?:0|0\.\d+|1)|(?:100%|(?:\d\.?\d?){1,}%)))?\))$/,
    named: !!w3c[color],
  };
