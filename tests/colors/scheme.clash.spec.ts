...
describe('Color scheme module', () => {
  describe('clash()', () => {
    ...
    test('with base only', () => {
      ...
      const schema: ColorSchemeClashOutput = {
        main: {
      ...
      expect(clash(data)).toMatchObject<ColorSchemeClashOutput>(schema);
    });
    test('with base, neutral = true', () => {
      ...
      expect(clash(data)).toMatchObject(schema);
    });
