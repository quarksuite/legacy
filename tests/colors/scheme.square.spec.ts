...
describe('Color scheme module', () => {
  describe('square()', () => {
    interface ColorSchemeSquareOutput {
      main: {
    ...
    test('with base only', () => {
      ...
      const schema: ColorSchemeSquareOutput = {
        main: {
      ...
      expect(square(data)).toMatchObject<ColorSchemeSquareOutput>(schema);
    });
    test('with base, neutral = true', () => {
      ...
      expect(square(data)).toMatchObject(schema);
    });
