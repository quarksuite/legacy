...
describe('Color scheme module', () => {
  describe('analogous()', () => {
    ...
    test('with base only', () => {
      ...
      const schema: ColorSchemeAnalogousOutput = {
        main: {
      ...
      expect(analogous(data)).toMatchObject<ColorSchemeAnalogousOutput>(schema);
    });
    test('with base, neutral = true', () => {
      ...
      expect(analogous(data)).toMatchObject(schema);
    });
